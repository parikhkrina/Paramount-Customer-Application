...
import paramount.com.androidproject.models.User;
import paramount.com.androidproject.utils.DiavloMediumRegularTextView;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void registerUser() {
        ...
        final String mobile = et_phoneNumber.getText().toString();
                ...
                addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            final User user = new User(name, mobile, email);
